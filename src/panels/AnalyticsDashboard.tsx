...
const AnalyticsDashboard: React.FC = () => {
  const [_activeView, setActiveView] = useState<AnalyticsView>("overview");
  const [_orgAnalytics, setOrgAnalytics] =
    useState<OrganizationAnalytics | null>(null);
  const [_donorInsights, setDonorInsights] = useState<DonorInsights | null>(
    null,
  );
