        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Brand-aware generation of direct mail, email series, and social
              posts
            </p>
          </div>
        ...
        {showClientSelector && (
          <div className="rounded-xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 p-6 text-center">
            <p className="text-blue-800 dark:text-blue-200">
              Please select a client from the dropdown above to begin designing
              a campaign.
            </p>
          </div>
        )}
          ...
          <>
            <section className="rounded-xl border border-gray-300 dark:border-gray-700 p-5 bg-gray-50 dark:bg-gray-800/50 space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                  {["Urgent", "Inspiring", "Reflective", "Grateful"].map(
                    (t) => (
                      <option key={t} value={t}>
                        {t}
                      </option>
            ...
            <section className="rounded-xl border border-gray-300 dark:border-gray-700 p-5 bg-gray-50 dark:bg-gray-800/50 space-y-4">
              ...
              {!canGenerate && (
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  Fill in the basics, audience, goal, tone, and select at least
                  one channel.
                </div>
              )}
              {error && (
