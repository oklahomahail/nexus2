  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-10 px-6 space-y-16">
      ...
      <div className="space-y-6">
        <h1 className="text-h1 font-semibold text-charcoal">Heading 1 – 32px</h1>
        <h2 className="text-h2 font-semibold text-charcoal">Heading 2 – 24px</h2>
        ...
        <p className="text-body text-charcoal">
          ...
          built on Inter and Libre Franklin. Paragraph text keeps a restrained hierarchy,
          maximizing readability across campaign creation, analytics, and donor strategy views.
        </p>
      ...
      {/* COLOR SYSTEM */}
      {/* ------------------------------------------------------------------ */}
      <SectionHeader title="Color Palette" subtitle="Nexus editorial identity" />
      ...
      <div className="space-y-6 max-w-xl">
        ...
        <Input placeholder="With helper text" label="Username" helperText="Choose a unique username" />
        <Input placeholder="Error state" label="Password" error helperText="Password is required" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <p className="text-body text-muted">
            Cards are used for analytics blocks, donor stats, segmentation views, and more.
          </p>
        </Card>
        ...
        <Card hover>
          ...
          <p className="text-body text-muted">
            Simple, clean, editorial containers with subtle elevation and hover effect.
          </p>
        </Card>
      </div>
      ...
      {/* PANELS */}
      {/* ------------------------------------------------------------------ */}
      <SectionHeader title="Panels" subtitle="Editorial containers for feature blocks" />

      <Panel title="Panel Header" subtitle="With optional subtitle">
        <p className="text-body text-muted mb-4">
          Panels serve as content sections within feature pages: campaign editor, donor insights,
          or brand management.
        </p>
      ...
      <div className="border border-border rounded-md p-6 bg-white shadow-sm">
        <p className="text-body text-muted">
          Active tab: <span className="font-medium text-charcoal">{activeTab}</span>
        </p>
      </div>
      ...
      {/* SPACING SYSTEM */}
      {/* ------------------------------------------------------------------ */}
      <SectionHeader title="Spacing System" subtitle="Editorial rhythm and vertical flow" />

      <div className="space-y-4">
        <div>
          <div className="h-4 bg-gray-200 w-full rounded-sm mb-2" />
          <p className="text-xs text-muted">4px - Extra Small (--nx-space-xs)</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-xs text-muted">24px - Extra Large (--nx-space-xl)</p>
        </div>
      </div>

      <p className="text-small text-muted mt-6">
        Nexus spacing tokens: 4px, 8px, 12px, 16px, 24px, 32px, 48px increments. Editorial rhythm uses 24px and 32px
        section spacing to create a high-end feel across the platform.
      </p>
      ...
      {/* SHADOWS & ELEVATION */}
      {/* ------------------------------------------------------------------ */}
      <SectionHeader title="Shadows & Elevation" subtitle="Depth system for layering" />

      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="p-6 bg-white rounded-md" style={{ boxShadow: "var(--nx-shadow-sm)" }}>
          <p className="text-small font-medium mb-1">Small</p>
          <p className="text-xs text-muted">Subtle depth</p>
        </div>
        <div className="p-6 bg-white rounded-md" style={{ boxShadow: "var(--nx-shadow-md)" }}>
          <p className="text-small font-medium mb-1">Medium</p>
          <p className="text-xs text-muted">Cards</p>
        </div>
        <div className="p-6 bg-white rounded-md" style={{ boxShadow: "var(--nx-shadow-lg)" }}>
          <p className="text-small font-medium mb-1">Large</p>
          <p className="text-xs text-muted">Elevated panels</p>
        </div>
        <div className="p-6 bg-white rounded-md" style={{ boxShadow: "var(--nx-shadow-xl)" }}>
