...
export default function ClientReports() {
  ...
  const reports = [
    { id: 1, name: "Quarterly Fundraising Summary", date: "2025-03-15", type: "Fundraising" },
    { id: 2, name: "Donor Retention Analysis", date: "2025-03-10", type: "Analytics" },
    ...
    <div className="p-6" data-tutorial-step="reports.panel">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg border">
          ...
          <p className="text-gray-600 text-sm mb-4">Revenue, donations, and goal tracking</p>
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          <p className="text-gray-600 text-sm mb-4">Donor analysis and segmentation</p>
          <button className="w-full px-3 py-2 border rounded-md hover:bg-gray-50">
            Create Donor Report
          </button>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          <p className="text-gray-600 text-sm mb-4">Campaign performance and ROI</p>
          <button className="w-full px-3 py-2 border rounded-md hover:bg-gray-50">
