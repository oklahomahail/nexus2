...
export const demoCampaignData: CreateCampaignData = {
  ...
  description: "Holiday giving campaign to provide warm meals and food boxes to families in need during the winter season. Focus on community generosity and the spirit of giving.",
  goal: 10000,
  startDate: "2025-11-15",
  endDate: "2025-12-31",
  category: "General",
  targetAudience: "Existing donors, volunteers, local businesses, community supporters",
  tags: ["End-of-Year", "Holiday", "Food Security", "Community", "Winter"],
  notes: "Coordinate with local businesses for matching gifts. Plan volunteer events for food box packing."
};
