  ...
  insights: [
    {
      ...
      message: "Email campaigns are driving 58% of total revenue with strong conversion rates"
    },
    {
      type: "opportunity", 
      metric: "Social Media",
      message: "Social media has the highest average gift size - consider increasing investment"
    },
    {
      type: "warning",
...
export const demoReportData = {
  ...
  executive_summary: {
    ...
    recommendation: "Focus on expanding email campaigns and volunteer-to-donor conversion"
  },
