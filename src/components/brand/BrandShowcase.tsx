...
export function BrandShowcase() {
  const colors = [
    { name: 'Indigo Nexus', var: '--accent', hex: '#3B36F4', description: 'Primary brand color' },
    { name: 'Electric Cyan', var: '--accent-2', hex: '#72E4FC', description: 'Secondary accent' },
    { name: 'Deep Violet', var: '--accent-3', hex: '#6B4DFF', description: 'Shadow glow' },
    { name: 'Nexus Night', var: '--bg', hex: '#0D0D12', description: 'Background' },
    { name: 'Slate Layer', var: '--panel', hex: '#1A1A22', description: 'Surface' },
    { name: 'Growth Green', var: '--success', hex: '#4ADE80', description: 'Success' },
    { name: 'Insight Amber', var: '--warn', hex: '#FACC15', description: 'Warning' },
    { name: 'Privacy Red', var: '--error', hex: '#F87171', description: 'Error' },
  ]
    ...
    <div className="min-h-screen bg-[#0D0D12] text-white p-8">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <section className="space-y-6">
          <h2 className="text-3xl font-bold border-b border-[#2D2D3A] pb-3">Logo System</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#1A1A22] rounded-2xl p-8 flex flex-col items-center justify-center gap-4 border border-[#2D2D3A]">
              ...
              <p className="text-sm text-muted text-center">Primary Lockup<br />Use for headers & splash screens</p>
            </div>

            {/* Symbol Only */}
            <div className="bg-[#1A1A22] rounded-2xl p-8 flex flex-col items-center justify-center gap-4 border border-[#2D2D3A]">
              <NexusIcon size={64} />
              <p className="text-sm text-muted text-center">Symbol Only<br />Use for icons & badges</p>
            </div>

            {/* Animated */}
            <div className="bg-[#1A1A22] rounded-2xl p-8 flex flex-col items-center justify-center gap-4 border border-[#2D2D3A]">
              <NexusLogo size={64} showWordmark animated />
              <p className="text-sm text-muted text-center">Animated<br />Use for loading states</p>
            </div>
          </div>
        ...
        {/* Color Palette */}
        <section className="space-y-6">
          <h2 className="text-3xl font-bold border-b border-[#2D2D3A] pb-3">Color System</h2>
            ...
            {colors.map((color) => (
              ...
              >
                ...
                <div className="bg-[#1A1A22] p-4">
                  ...
                  <code className="text-xs font-mono text-[#72E4FC]">{color.hex}</code>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="rounded-xl overflow-hidden border border-[#2D2D3A]">
            ...
            <div className="bg-[#1A1A22] p-4">
              ...
              <p className="text-xs text-muted mb-2">Use for buttons, headers, or hero backgrounds</p>
        ...
        {/* Typography */}
        <section className="space-y-6">
          <h2 className="text-3xl font-bold border-b border-[#2D2D3A] pb-3">Typography</h2>
          ...
          <div className="bg-[#1A1A22] rounded-2xl p-8 space-y-6 border border-[#2D2D3A]">
            ...
            <div>
              ...
              <p className="text-body">
                Nexus is a privacy-first fundraising platform that combines donor analytics,
                AI-powered campaign generation, and multi-channel automation.
              </p>
            </div>
            <div>
              <p className="text-xs text-muted mb-2">Caption - 13px</p>
              <p className="text-body-sm text-muted">
                This metric only includes cohorts of 50+ donors to protect privacy.
              </p>
            </div>
            <div>
              <p className="text-xs text-muted mb-2">Monospace - JetBrains Mono</p>
        ...
        {/* Animations */}
        <section className="space-y-6">
          <h2 className="text-3xl font-bold border-b border-[#2D2D3A] pb-3">Motion System</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#1A1A22] rounded-2xl p-8 flex flex-col items-center justify-center gap-4 border border-[#2D2D3A]">
              ...
              <p className="text-sm text-muted text-center">Pulse<br />3s ease-in-out</p>
            </div>
            ...
            <div className="bg-[#1A1A22] rounded-2xl p-8 flex flex-col items-center justify-center gap-4 border border-[#2D2D3A]">
              ...
              <p className="text-sm text-muted text-center">Glow<br />3s ease-in-out</p>
            </div>
            ...
            <div className="bg-[#1A1A22] rounded-2xl p-8 flex flex-col items-center justify-center gap-4 border border-[#2D2D3A]">
              ...
              <p className="text-sm text-muted text-center">Orbit<br />20s linear</p>
            </div>
          </div>
        </section>
        ...
        {/* Gradient Text */}
        <section className="space-y-6">
          <h2 className="text-3xl font-bold border-b border-[#2D2D3A] pb-3">Gradient Text</h2>

          <div className="bg-[#1A1A22] rounded-2xl p-12 flex flex-col items-center justify-center border border-[#2D2D3A]">
            <h1 className="text-6xl font-bold nexus-glow-text mb-4">
              Nexus Intelligence
            </h1>
            <p className="text-muted">Use .nexus-glow-text for gradient text effects</p>
          </div>
        </section>

        {/* Usage Guidelines */}
        <section className="space-y-4">
          <h2 className="text-3xl font-bold border-b border-[#2D2D3A] pb-3">Usage Guidelines</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Correct */}
            <div className="bg-[#1A1A22] rounded-2xl p-6 border border-green-500/20">
              <h3 className="text-xl font-semibold mb-4 text-green-400">✓ Correct Usage</h3>
            ...
            <div className="bg-[#1A1A22] rounded-2xl p-6 border border-red-500/20">
              <h3 className="text-xl font-semibold mb-4 text-red-400">✗ Incorrect Usage</h3>
              <ul className="space-y-2 text-sm text-muted">
        ...
        <div className="text-center text-sm text-muted pb-12">
          ...
          <p className="mt-2">For questions, see <code className="text-[#72E4FC]">BRAND_GUIDE.md</code></p>
        </div>
      </div>
    </div>
  )
