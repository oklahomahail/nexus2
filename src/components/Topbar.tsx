...
const Topbar: React.FC<TopbarProps> = ({
  ...
  usePolling(fetchNotifications, {
    visibleInterval: 30000, // 30s when visible
    hiddenInterval: 180000, // 3min when hidden
    enabled: true,
  });
  ...
  const handleNotificationClick = useCallback(
    (notification: Notification) => {
      ...
      // Could navigate to relevant view based on notification type
    ...
    <header className="border-b border-slate-800/50 bg-slate-900/30 backdrop-blur-md sticky top-0 z-40">
      ...
      <div className="px-3 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          {/* Left: Brand + Title - Hide on mobile when actions are present */}
          ...
          <div className="flex-1 max-w-md mx-4 hidden md:block">
            {!(isClientsPage || isClientScoped) && showSearch && (
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="relative">
              ...
              {showUserMenu && (
                <div
                  className="absolute right-0 top-full mt-2 w-56 sm:w-64 bg-slate-800/95 backdrop-blur-sm border border-slate-700/50 rounded-xl shadow-lg animate-fade-in z-50"
                  role="menu"
                >
