  ...
  return (
    <Routes>
      <Route element={<AppShell />}>
        ...
        <Route path="/clients/:clientId/campaigns" element={
          <Suspense fallback={<PageLoader />}>
            <ClientCampaigns />
          </Suspense>
        } />
        <Route path="/clients/:clientId/campaigns/new" element={
          <Suspense fallback={<PageLoader />}>
            <CampaignBuilder />
          </Suspense>
        } />
        <Route path="/clients/:clientId/campaigns/:campaignId" element={
          <Suspense fallback={<PageLoader />}>
            <CampaignBuilder />
          </Suspense>
        } />
        ...
        <Route path="/clients/:clientId/reports" element={
          <Suspense fallback={<PageLoader />}>
            <ClientReports />
          </Suspense>
        } />
